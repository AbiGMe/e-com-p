...
public final class RestEcompApplicationPage<T> {
    ...
    private RestEcompApplicationPage(RestEcompApplicationPageBuilder<T> builder) {
    ...
    public static <S, T> RestEcompApplicationPage<T> from(EcompApplicationPage<S> source, Function<S, T> mapper) {
        Assert.notNull("source", source);
        Assert.notNull("mapper", mapper);

        return new RestEcompApplicationPageBuilder<>(source.content().stream().map(mapper).toList())
    ...
    private static final class RestEcompApplicationPageBuilder<T> {
        ...
        private RestEcompApplicationPageBuilder(List<T> content) {
            this.content = content;
        }

        public RestEcompApplicationPageBuilder<T> pageSize(int pageSize) {
            this.pageSize = pageSize;

            return this;
        }

        public RestEcompApplicationPageBuilder<T> currentPage(int currentPage) {
            this.currentPage = currentPage;

            return this;
        }

        public RestEcompApplicationPageBuilder<T> totalElementsCount(long totalElementsCount) {
            this.totalElementsCount = totalElementsCount;

            return this;
        }

        public RestEcompApplicationPageBuilder<T> pageCount(int pageCount) {
            this.pageCount = pageCount;

            return this;
        }

        public RestEcompApplicationPageBuilder<T> hasPrevious(boolean hasPrevious) {
            this.hasPrevious = hasPrevious;

            return this;
        }

        public RestEcompApplicationPageBuilder<T> hasNext(boolean hasNext) {
            this.hasNext = hasNext;

            return this;
        }

        public RestEcompApplicationPage<T> build() {
            return new RestEcompApplicationPage<>(this);
        }
    }
}
