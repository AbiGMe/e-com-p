...
public final class EcompApplicationPage<T> {
    ...
    private EcompApplicationPage(EcompApplicationPageBuilder<T> builder) {
        content = EcompApplicationCollections.immutable(builder.content);
        currentPage = builder.currentPage;
        pageSize = buildPageSize(builder.pageSize);
        totalElementsCount = buildTotalElementsCount(builder.totalElementsCount);
    }

    public static <T> EcompApplicationPage<T> singlePage(List<T> content) {
        return builder(content).build();
    }

    public static <T> EcompApplicationPageBuilder<T> builder(List<T> content) {
        return new EcompApplicationPageBuilder<>(content);
    }

    public static <T> EcompApplicationPage<T> of(List<T> elements, EcompApplicationPageable pagination) {
    ...
    public <R> EcompApplicationPage<R> map(Function<T, R> mapper) {
    ...
    public static final class EcompApplicationPageBuilder<T> {
        ...
        private EcompApplicationPageBuilder(List<T> content) {
            this.content = content;
        }

        public EcompApplicationPageBuilder<T> pageSize(int pageSize) {
            this.pageSize = pageSize;

            return this;
        }

        public EcompApplicationPageBuilder<T> currentPage(int currentPage) {
            this.currentPage = currentPage;

            return this;
        }

        public EcompApplicationPageBuilder<T> totalElementsCount(long totalElementsCount) {
            this.totalElementsCount = totalElementsCount;

            return this;
        }

        public EcompApplicationPage<T> build() {
            return new EcompApplicationPage<>(this);
        }
    }
}
