package com.abiy.ecomp.shared.authentication.application;

import com.abiy.ecomp.shared.authentication.domain.Role;
import com.abiy.ecomp.shared.authentication.domain.Roles;
...
public final class AuthenticatedUser {
    ...
    public static User getUser() {
        ...
        } else if (details.get("searchTerm") != null) {
            firstName = (String) details.get("searchTerm");
        }
