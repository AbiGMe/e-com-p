package com.abiy.ecomp.wire.cache.infrastructure.secondary;
...
class CacheConfiguration {
    ...
    public CacheConfiguration(EhcacheProperties properties) {
        this.configuration = Eh107Configuration.fromEhcacheCacheConfiguration(
            CacheConfigurationBuilder.newCacheConfigurationBuilder(
                    Object.class,
                    Object.class,
                    ResourcePoolsBuilder.heap(properties.getMaxEntries())
                )
